          ...
          <div className="mt-36">
            ...
            <div className="flex flex-col  sm:flex-row   border-b border-black">
              ...
              <div className="w-full sm:w-full md:w-1/2 flex-grow">
                <div className="flex">
                  <p className="min-w-unset sm:min-w-[200px] md:min-w-[220px] lg:min-w-[233px] text-center text-[20px] lg:text-2xl bg-bblue rounded-2xl px-3 py-3 md:px-8">
                    2023 - Present
                  </p>
                  <p className="min-w-unset sm:min-w-[210px] text-center text-[20px] lg:text-2xl  rounded-2xl px-3 py-3 md:px-8">
                    Jaguar LandRover
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row mb-2 mt-6">
              <div className="w-full font-inter font-600 text-[28px] md:text-[36px] mb-8 w-full md:w-1/2 ">
                Android Developer
              </div>
              <div className="w-full w-full md:w-1/2 flex-grow">
                <div className="flex ">
                  <p className="min-w-unset sm:min-w-[200px] md:min-w-[220px] lg:min-w-[233px] text-center text-[20px] lg:text-2xl bg-bblue rounded-2xl px-3 py-3 md:px-8">
                    2021 - 2022
                  </p>
